...
def build_system_prompt(rubric_text: str) -> str:
    return (
        ...
        "3. Match the signals to the rubric above and pick the single "
        "category whose definition best fits. Apply the rubric's own "
        "criteria — do not invent additional thresholds.\n"
        "4. Explicitly consider the closest alternative category and why "
        "it fits less well — this matters most on borderline cases. If "
        "the text genuinely doesn't fit any of the substantive categories "
        "in the rubric, only then fall back to the residual/ambiguous "
        "category. Do not use the residual category as a hedge when one "
        "of the substantive categories is a reasonable match.\n\n"
        ...
        "## Examples\n\n"
        "Text: \"People who think like this are a stain on humanity. The "
        "world would be a better place without your worthless kind in it. "
        "Hope someone teaches you what you really deserve one day you piece of shit.\"\n"
        "Response: {\"classification\": \"Very Toxic\"}\n\n"
        "Text: \"You're a worthless piece of trash and everyone who knows "
        "you is better off when you're not around. Do the world a favor "
        "and kill yourself.\"\n"
        "Response: {\"classification\": \"Very Toxic\"}\n\n"
        "Text: \"The PC local liberal good old boy club permeates Eugene "
        "like the KKK of the 1950's south is in full campaign mode to "
        "put a babbling ignorant fool with 0 experience into office of "
        "Mayor to replace Queen Piercy. You can cut and paste their "
        "talking points, and gee, these clones are doing just that.\"\n"
        "Response: {\"classification\": \"Toxic\"}\n\n"
        "Text: \"What a moronic take. Did you even think about this for "
        "five seconds before posting, or do you just enjoy embarrassing "
        "yourself in public? Some people really shouldn't be allowed "
        "near a keyboard.\"\n"
        "Response: {\"classification\": \"Toxic\"}\n\n"
        ...
        "Text: \"I really disagree with this analysis. The data on page "
        "3 contradicts the conclusion, and the author seems to have "
        "ignored several major counterexamples. Worth a more rigorous "
        "treatment.\"\n"
        "Response: {\"classification\": \"Not Toxic\"}\n\n"
        "## Output Format\n\n"
        "Respond with JSON only, no surrounding text. Assign exactly one "
        "classification from the rubric's categories.\n"
        "{\"classification\": \"...\"}"
    )
